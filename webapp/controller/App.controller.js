sap.ui.define(
    ...
    function (
        ...
        return Controller.extend(
            "sap.ui.core.tutorial.odatav4.controller.App",
            {
                /**
                ...
                onInit: function () {
                    ...
                    oMessageModelBinding.attachChange(
                ...
                onCreate: function () {
                    ...
                    this.getView()
                        .getModel("appView")
                        .setProperty("/usernameEmpty", true);
                    ...
                    if (oSelected) {
                        oSelected
                            ...
                            .then(
                                function () {
                                    MessageToast.show(
                                        this._getText("deletionSuccessMessage")
                                    );
                                }.bind(this),
                                function (oError) {
                ...
                onRefresh: function () {
                    ...
                    if (oBinding.hasPendingChanges()) {
                        MessageBox.error(
                            this._getText("refreshNotPossibleMessage")
                        );
                        return;
                    }
                    oBinding.refresh();
                ...
                onResetDataSource: function () {
                    ...
                    oOperation.execute().then(
                        function () {
                            oModel.refresh();
                            MessageToast.show(
                                this._getText("sourceResetSuccessMessage")
                            );
                        }.bind(this),
                        function (oError) {
                            MessageBox.error(oError.message);
                ...
                onSelectionChange: function (oEvent) {
                    ...
                    var oOldContext = oDetailArea.getBindingContext(),
